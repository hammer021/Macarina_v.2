...
public class ActivityCheckoutCoklat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkout_coklat);
        ...
        gambarbarange = findViewById(R.id.imgGambarbrg1);
        nmbrg = findViewById(R.id.textbarang1);
        hrg = findViewById(R.id.textharga1);
        stk = findViewById(R.id.textstok1);
        dskrpsi = findViewById(R.id.textdeskripsinya1);

        qty = findViewById(R.id.qtytrans1);

        Picasso.get().load(mPathGambar).into(gambarbarange);

        btnsave = findViewById(R.id.addcart1);
        ...
        btnkembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent tosoon = new Intent(ActivityCheckoutCoklat.this, ActivityPilihVarian.class);
    ...
    {
        StringRequest brgload1 = new StringRequest(Request.Method.GET, ServerApi.URL_BRGCKL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    Toast.makeText(ActivityCheckoutCoklat.this, e.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ActivityCheckoutCoklat.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
        requestQueue.add(brgload1);
    }
    ...
    private void addcart()
    {
        ...
        StringRequest cartadd1 = new StringRequest(Request.Method.POST, ServerApi.URL_ADDCART + mKodeBarang, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    if (status.equals("200") && error.equals("false")) {
                        Toast.makeText(ActivityCheckoutCoklat.this, message, Toast.LENGTH_SHORT).show();
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Intent intent2 = new Intent(ActivityCheckoutCoklat.this, MainActivity.class);
                    ...
                    e.printStackTrace();
                    Intent intent3 = new Intent(ActivityCheckoutCoklat.this, MainActivity.class);
